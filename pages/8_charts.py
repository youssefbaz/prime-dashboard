...
with sc2:
    st.markdown(f'<div class="s-card"><div class="s-label">Tasks completed</div><div class="s-val" style="color:#34d399;">{total_tasks_done}</div></div>', unsafe_allow_html=True)
with sc3:
...
# ── Tabs ──────────────────────────────────────────────────
t1, t2, t3 = st.tabs(["📋 Checklist", "⚖️ Weight", "💼 Jobs pipeline"])
